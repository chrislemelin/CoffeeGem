...
public class IngredientInventoryItemDragSpawner : MonoBehaviour, IDragHandler, IEndDragHandler {
    ...
    public void OnDrag(PointerEventData eventData) {
        if (firstFrame) {
            firstFrame = false;
            GetComponentInChildren<ButtonCG>().setDuration(0.0f);
    ...
    public void OnEndDrag(PointerEventData eventData) {
        ...
        GetComponentInChildren<ButtonCG>().setDuration(.1f);
        firstFrame = true;
